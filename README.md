...
- AI API 키는 서버 환경 변수에만 두며, 월간 보고서 생성 시 수업·성적·상담 요약 JSON이 OpenRouter로 전송됩니다.

## 월간 보고서 (AI · PDF)

- **기본 보고서**: 기존처럼 통계 템플릿으로 문장을 만듭니다.
- **AI 분석 포함**: `월간보고서` 화면에서 학생·연월 선택 후 **AI 분석 포함**을 누르면, 같은 달 수업·상담·학습 신호를 바탕으로 `【학습 분석】`, `【학생 피드백·관찰】`, `【다음 달 지도 제안】` 구간을 추가합니다.
